...
import com.axcess.axcessaiqrscanner.camera.CameraSource;
import com.axcess.axcessaiqrscanner.camera.CameraSourcePreview;
import com.axcess.axcessaiqrscanner.camera.GraphicOverlay;
...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        rect=findViewById(R.id.rootview);
        ...
        findViewById(R.id.ll_capture).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void requestCameraPermission() {
        ...
        /*Snackbar.make(mGraphicOverlay, R.string.permission_camera_rationale,
                ...
                .show();*/
        Toast.makeText(getApplicationContext(),"Access to the camera is needed for detection",Toast.LENGTH_SHORT).show();
    }
    ...
    private static String encodeValue(String txt, String toencode) {
        try {
            return URLEncoder.encode(txt, toencode);
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        jpegCallback = new CameraSource.PictureCallback() {
            public void onPictureTaken(byte[] data) {
               ...
               /* int centreX= (int) (rect.getRootView().getX() + rect.getRootView().getWidth()  / 2);
                int centreY= (int) (rect.getRootView().getY() + rect.getRootView().getHeight() / 2);
                ...
                Bitmap imagemCortada
                = Bitmap.createBitmap(bitmap, 0,(int) ((height/2)-200), width,  400);
                ((ImageView)findViewById(R.id.cclick)).setImageBitmap(imagemCortada);*/
                //.../
                ...
                String posturl = "https://axcess.ai/?action=smsverify&t=eventticket&token="+ dopass +"&subticket=";
                urlres = stringBuilder.toString();
                //urlres = URLEncoder.encode(urlres,HTTP.UTF_8);
               // urlres = urlres.substring(urlres.indexOf("(") + 1);
                //urlres = urlres.substring(0, urlres.indexOf(")"));

                try {
                    urlres = URLEncoder.encode(urlres,"UTF-8");
                ...
                final RequestQueue requestQueue = Volley.newRequestQueue(OcrCaptureActivity.this);
                StringRequest stringRequest = new StringRequest(Request.Method.POST, posturl,
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                Intent intent = new Intent(OcrCaptureActivity.this, scan_success.class);
